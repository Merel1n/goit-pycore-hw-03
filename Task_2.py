...
# Вона буде повертати випадковий набір чисел у межах заданих параметрів, причому всі випадкові числа 
# в наборі повинні бути унікальні.
...
min = int(input("Мінімальне можливе число у наборі (не менше 1) "))
...
random_numbers = get_numbers(min, max, quantity)
  
print (f"Your random numbers {random_numbers}")